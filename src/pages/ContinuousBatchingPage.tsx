...
const HatIcon = () => (
  <svg width="18" height="18" viewBox="0 0 80 80" fill="none" aria-hidden>
    <ellipse cx="40" cy="57" rx="34" ry="11" fill="#EE0000" />
    <path d="M16 57 Q16 37 40 29 Q64 37 64 57Z" fill="#CC0000" />
    <ellipse cx="40" cy="29" rx="15" ry="7.5" fill="#EE0000" />
    <rect x="31" y="21" width="18" height="10" rx="5" fill="#CC0000" />
  </svg>
);
  ...
  return (
    <div className="bakery-page">
      ...
      <nav>
        ...
        <div className="nav-title">Continuous Batching</div>
        <div className="nav-badge">06 / 07</div>
      </nav>
      ...
      <div className="bakery-section">
        ...
        <div className="rhs">
          ...
          <div className="rhs-links">
            <a
              className="rhl"
              href="https://www.redhat.com/en/products/ai/red-hat-ai-inference-server"
              target="_blank"
              rel="noreferrer"
            >
              <LinkOutIcon />
            ...
            <a className="rhl" href="https://docs.vllm.ai/" target="_blank" rel="noreferrer">
              <LinkOutIcon />
              vLLM docs
            </a>
          </div>
